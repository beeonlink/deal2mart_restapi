...
export declare type ConfigurationObjectCLI = {
    ...
    warnError?: boolean;
} & Pick<DocOptions, 'config' | 'debug' | 'colorize' | 'copyDefinitions' | 'encoding' | 'excludeFilters' | 'includeFilters' | 'filterBy' | 'filters' | 'languages' | 'parsers' | 'workers' | 'apiprivate' | 'silent' | 'single' | 'verbose'>;
